...
class MeowModel(object):
    def __init__(self, cacheDir):
        ...
        self.rank_alpha_mult = float(os.environ.get("MEOW_RANK_ALPHA_MULT", "0.5"))
        self.time_basis_alpha_mult = float(os.environ.get("MEOW_TIME_BASIS_ALPHA_MULT", "0.5"))
        ...
        self.time_sq_alpha_mult = float(os.environ.get("MEOW_TIME_SQ_ALPHA_MULT", "0.5"))
        self.u_sq_alpha_mult = float(os.environ.get("MEOW_U_SQ_ALPHA_MULT", "0.5"))
