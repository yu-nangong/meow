...
MODEL_TYPE = os.environ.get("MEOW_MODEL_TYPE", "xgb_only").strip().lower()
...
SEQ_MODEL_ENABLED = os.environ.get("MEOW_SEQ_MODEL", "1") != "0"
SEQ_BLEND_WEIGHT = float(os.environ.get("MEOW_SEQ_BLEND_WEIGHT", "0.1"))
