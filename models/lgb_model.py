...
class LGBModel:
    def __init__(self):
        self.max_rows = int(os.environ.get("MEOW_LGB_MAX_ROWS", "1500000"))
        ...
        self.extra_trees = os.environ.get("MEOW_LGB_EXTRA_TREES", "1") != "0"
        ...
        self.reg_lambda = float(os.environ.get("MEOW_LGB_REG_LAMBDA", "0.2"))
