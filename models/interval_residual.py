...
class IntervalResidualRidge:
    def __init__(self):
        ...
        raw_base_rank_interactions = os.environ.get(
            ...
            "trade_imb_rank_cs,flow_imb_rank_cs,high_minus_low_rank_cs,midpx_level_rank_cs,lastpx_level_rank_cs,tradeBuyQty_level_rank_cs,tradeSellQty_level_rank_cs,bsize0_level_rank_cs,asize0_level_rank_cs,buyVwad_level_rank_cs,sellVwad_level_rank_cs,nTradeBuy_level_rank_cs,nTradeSell_level_rank_cs,ret3_minus_ret1_rank_cs,ret6_minus_ret3_rank_cs,ret6_vol_rank_cs,ret12_vol_rank_cs",
        )
