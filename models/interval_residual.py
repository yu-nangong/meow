...
class IntervalResidualRidge:
    def __init__(self):
        ...
        self.prior_alpha = float(os.environ.get("MEOW_INTERVAL_RESIDUAL_PRIOR_ALPHA", "1.0"))
        self.blend = float(os.environ.get("MEOW_INTERVAL_RESIDUAL_BLEND", "0.25"))
        ...
        self.neighbor_alpha = float(os.environ.get("MEOW_INTERVAL_RESIDUAL_NEIGHBOR_ALPHA", "0.3"))
